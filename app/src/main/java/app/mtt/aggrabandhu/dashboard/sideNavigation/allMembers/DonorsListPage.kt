...
import app.mtt.aggrabandhu.viewmodel.AllMembersViewModel
...
private fun DonorsCard (
    ...
    Card(
        ...
        Row(
            ...
            CircularImage(
                size = 54.dp,
                painter = if (allMemberData.profileUrl != null) {
                    rememberAsyncImagePainter(baseUrl+allMemberData.profileUrl)
                } else rememberVectorPainter(
                    image = Icons.Default.PersonPin
                )
            )
